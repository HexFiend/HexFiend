...
@objc public class HFByteTheme: NSObject {
    ...
    private static var namesToColors: [String: NSColor?] = {
        var map: [String: NSColor] = [
            "blackColor": .black.toRGB(),
            "blueColor": .blue.toRGB(),
            "brownColor": .brown.toRGB(),
            "clearColor": .clear.toRGB(),
            "cyanColor": .cyan.toRGB(),
            "darkGrayColor": .darkGray.toRGB(),
            "grayColor": .gray.toRGB(),
            "greenColor": .green.toRGB(),
            "lightGrayColor": .lightGray.toRGB(),
            "magentaColor": .magenta.toRGB(),
            "orangeColor": .orange.toRGB(),
            "purpleColor": .purple.toRGB(),
            "redColor": .red.toRGB(),
            "systemBlueColor": .systemBlue.toRGB(),
            "systemBrownColor": .systemBrown.toRGB(),
            "systemGrayColor": .systemGray.toRGB(),
            "systemGreenColor": .systemGreen.toRGB(),
            "systemMintColor": .systemMint.toRGB(),
            "systemOrangeColor": .systemOrange.toRGB(),
            "systemPinkColor": .systemPink.toRGB(),
            "systemPurpleColor": .systemPurple.toRGB(),
            "systemRedColor": .systemRed.toRGB(),
            "systemTealColor": .systemTeal.toRGB(),
            "systemYellowColor": .systemYellow.toRGB(),
            "whiteColor": .white.toRGB(),
            "yellowColor": .yellow.toRGB(),
        ]
